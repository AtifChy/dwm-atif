...
static const char hp[] 		    	 = "discord,alacritty,dwmblocks,chromium,brave,systemsettings5,redshift-gtk,nm-applet,picom,dunst";  /* if you want dmenu to find an app quickly then add it here */
...
//	{ MODKEY,                       XK_h,          setlayout,              {.v = &layouts[8]} },
