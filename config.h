...
static const char font[]                 = "Fira Code Medium 10";
static const char dmenufont[]            = "Fira Code Medium:size=10";
// dmenu configuration
static const char x[] 		    	 = "10";
static const char y[] 	 	    	 = "10";
static const char w[] 		    	 = "1900"; 	/* dmenu width 	*/
static const char p[] 		    	 = "Run:";   /* prompt  */
static const char p1[] 		    	 = "Clipmenu:";
static const char hp[] 		    	 = "dwmblocks,chromium,brave,systemsettings5,redshift-gtk,nm-applet,picom,dunst";  /* if you want dmenu to find an app quickly then add it here */
